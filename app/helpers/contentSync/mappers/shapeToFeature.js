...
module.exports = (content, shape) => ({
	...
	attributes: {
		...
		startRoadworkLabel_nl: getStringWithMaxLength(150, ["fields", "startRoadworkLabel", "nl"])(content),
		startRoadworkLabel_fr: getStringWithMaxLength(150, ["fields", "startRoadworkLabel", "fr"])(content),
		startRoadworkLabel_en: getStringWithMaxLength(150, ["fields", "startRoadworkLabel", "en"])(content),
		startRoadworkLabel_de: getStringWithMaxLength(150, ["fields", "startRoadworkLabel", "de"])(content),
		endRoadworkLabel_nl: getStringWithMaxLength(150, ["fields", "endRoadworkLabel", "nl"])(content),
		endRoadworkLabel_fr: getStringWithMaxLength(150, ["fields", "endRoadworkLabel", "fr"])(content),
		endRoadworkLabel_en: getStringWithMaxLength(150, ["fields", "endRoadworkLabel", "en"])(content),
		endRoadworkLabel_de: getStringWithMaxLength(150, ["fields", "endRoadworkLabel", "de"])(content),
